...
### 📚 第1-2课时: 大语言模型基础与Prompt工程 (09:00-10:30)
...
### 📚 第3-4课时: 大模型工作流：从链式到图式 (10:45-12:15)
...
### 📚 第5-6课时: 智能体架构：ReAct、反思、规划 (13:30-15:00)
...
### 📚 第7-8课时: 记忆与工具：构建完整Agent (15:15-16:45)
...
### 📚 第9-10课时: 多智能体协作与编排框架 (09:00-10:30)
...
### 📚 第11-12课时: MCP协议与工具生态 (10:45-12:15)
...
### 📚 第13-14课时: 大模型操作系统与前沿系统 (13:30-15:00)
...
### 📚 第15-16课时: 商业应用与未来展望 (15:15-16:45)
...
| 课堂参与 | 20% | 讨论、提问、演示互动 |
| 实验报告 | 30% | 4个Lab的完成情况 |
| 案例分析 | 25% | 选择一个行业，设计Agent方案 |
| 期末展示 | 25% | 小组展示Agent应用创意 |
...
- **必需**: 笔记本电脑、稳定网络
- **软件**: Claude Desktop、Cursor (试用)
- **API**: 课程提供Claude API额度
- **可选**: Python环境 (用于Lab深度实验)
